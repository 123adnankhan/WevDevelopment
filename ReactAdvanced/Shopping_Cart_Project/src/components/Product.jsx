...
const Product = ({post}) => {
 ...
 // Redux ka istemal karke fun call dispatch method ke through hota hai 
  const addToCart = () => {
       // dispatch kardo add function ke andar kya add karni hai item ya tumhari post add krni hai
    dispatch(add(post));
  ...
  return (
    ...
    hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl outline" >
      ...
      <div className="flex justify-between gap-12 items-center w-full mt-5">
        ...
        {
          // checking if current item is present in the cart or not
